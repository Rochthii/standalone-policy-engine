...
| Production release readiness | NO-GO | Local unit/vet/format and Compose configuration checks pass, but mandatory release evidence has not accepted a candidate and remote CI has not been inspected. G0, G6, G7, G8 and G9 remain open; local race verification is blocked without CGO. See `evidence/REL_GATE_2026_09_17.md`. |
